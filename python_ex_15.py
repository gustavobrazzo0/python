...
ganhora = float(input("informe o valor ganho em horas"))

horames = float(input("informe a quantidade de horas trabalhadas "))

salario = ganhora * horames

print("seu salário bruto é de: {}, sendo, {} R$ pagos de INSS, {} pagos a")